...
public class Parser {
    ...
    /**
     * Insieme di parole chiave da ignorare o escludere durante l'analisi del
     * testo. Le parole chiave sono utilizzate per identificare parole comuni o
     * poco significative che non contribuiscono alla comprensione del testo.
     * Questo insieme di parole chiave viene utilizzato per filtrare e rimuovere
     * tali parole durante le operazioni di analisi del testo.
     */
    private final Set<String> stopwords;

    /**
     * Crea un nuovo oggetto Parser con l'insieme di parole chiave da ignorare
     * durante l'analisi del testo.
     *
     * @param stopwords l'insieme di parole chiave da ignorare durante l'analisi
     * del testo
     */
     ...
     *
     * @return Un oggetto ParserOutput il quale contiene il risultato del
     * parsing
     */
