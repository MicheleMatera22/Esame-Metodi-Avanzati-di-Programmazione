...
public class Music {
    ...
    /**
     * Avvia la riproduzione della musica di sottofondo. Viene mostrato un
     * messaggio di conferma all'utente per attivare la musica. Se l'utente
     * conferma, la musica viene riprodotta. Se il file audio non viene trovato
     * o si verificano errori durante la riproduzione, vengono stampati messaggi
     * di errore sulla console.
     */
    public static void startMusic() {

        try {
            File musicPath = new File(".//resources//music//Prison Break Soundtrack.wav");
