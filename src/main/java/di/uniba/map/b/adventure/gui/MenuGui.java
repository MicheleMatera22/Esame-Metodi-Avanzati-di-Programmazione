...
public class MenuGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(ExitGame, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 410, 250, 30));
        ...
        getContentPane().add(LoadGame, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, 270, 40));
        ...
        getContentPane().add(NewGame, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 270, 40));

        background.setIcon(new javax.swing.ImageIcon(".//resources//images//backgroundMenu.jpg"));
    ...
    /**
     * Gestisce l'evento generato quando viene premuto il pulsante "Nuova
     * Partita". Effettua le operazioni necessarie per avviare una nuova
     * partita. Chiude la finestra corrente, ferma la riproduzione della musica,
     * crea una nuova connessione al database, crea la tabella nel database,
     * elimina i dati del giocatore precedentemente salvati, elimina gli oggetti
     * utilizzati precedentemente nel gioco e avvia la finestra del motore di
     * gioco.
     *
    ...
    /**
     * Gestisce l'evento generato quando viene premuto il pulsante "Carica
     * Partita". Effettua le operazioni necessarie per caricare una partita
     * salvata. Crea una connessione al database, crea la tabella nel database,
     * verifica se esistono dati di gioco salvati per il giocatore. Se esistono,
     * chiude la finestra corrente, imposta il flag di partita caricata a true e
     * avvia la finestra del motore di gioco. Altrimenti, mostra un messaggio di
     * errore.
     *
     * @param evt l'evento generato
     */
  private void LoadGameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoadGameActionPerformed
    ...
    /**
     * Gestisce l'evento generato quando viene premuto il pulsante "Esci dal
     * Gioco". Mostra una finestra di dialogo di conferma per chiedere
     * all'utente se è sicuro di voler uscire dal gioco. Se l'utente conferma
     * l'uscita, il metodo termina l'applicazione.
     *
     * @param evt l'evento generato
     */
 ...
 *
    ...
    /**
     * Inizializza il font utilizzato nell'applicazione. Carica il file del font
     * personalizzato e imposta il font.
     */
